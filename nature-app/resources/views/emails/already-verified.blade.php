...
<body class="bg-gray-100 flex items-center justify-center min-h-screen">
    <div class="bg-white shadow-lg rounded-2xl p-10 max-w-lg text-center">
        ...
        <h1 class="text-2xl font-bold text-gray-800 mb-4">Email Already Verified</h1>
        <p class="text-gray-600 mb-6">
            Your email address is already verified. You can log in and start using your account.
        </p>
